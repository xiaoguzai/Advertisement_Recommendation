...
def gen_sub_multitasking(test_users, prediction, all_articles, worker_id):
    ...
    os.makedirs('/home/xiaoguzai/数据/新闻推荐/user_data/sub', exist_ok=True)

    with open(f'/home/xiaoguzai/数据/新闻推荐/user_data/sub/{worker_id}.pkl', 'wb') as f:
        pickle.dump(lines, f)
...
def gen_sub(prediction):
    ...
    sub_sample = pd.read_csv('/home/xiaoguzai/数据/新闻推荐/testA_click_log.csv')
    ...
    # 清空临时文件夹
    r"""
    for path, _, file_list in os.walk('/home/xiaoguzai/数据/新闻推荐/user_data/sub'):
