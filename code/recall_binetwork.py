...
def recall(df_query, item_sim, user_item_dict, worker_id):
    ...
    os.makedirs('/home/xiaoguzai/数据/新闻推荐/user_data/tmp/binework', exist_ok=True)
    df_data.to_pickle(f'/home/xiaoguzai/数据/新闻推荐/user_data/tmp/binework/{worker_id}.pkl')
...
if __name__ == '__main__':
    if mode == 'valid':
        ...
        sim_pkl_file = '/home/xiaoguzai/数据/新闻推荐/user_data/sim/offline/binetwork_sim.pkl'
    else:
        ...
        sim_pkl_file = '/home/xiaoguzai/数据/新闻推荐/user_data/sim/online/binetwork_sim.pkl'
    ...
    r"""
    # 清空临时文件夹
    for path, _, file_list in os.walk('/home/xiaoguzai/数据/新闻推荐/user_data/tmp/binework'):
    ...
    # 保存召回结果
    if mode == 'valid':
        df_data.to_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/data/offline/recall_binetwork.pkl')
    else:
        df_data.to_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/data/online/recall_binetwork.pkl')
