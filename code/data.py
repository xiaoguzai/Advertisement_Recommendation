...
# 初始化日志
os.makedirs('/home/xiaoguzai/数据/新闻推荐/log', exist_ok=True)
log = Logger(f'/home/xiaoguzai/数据/新闻推荐/log/{logfile}').logger
...
def data_offline(df_train_click, df_test_click):
    ...
    df_click.to_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/data/offline/click.pkl')
    df_query.to_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/data/offline/query.pkl')
...
def data_online(df_train_click, df_test_click):
    ...
    # 保存文件
    os.makedirs('/home/xiaoguzai/数据/新闻推荐/user_data/online', exist_ok=True)

    df_click.to_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/data/online/click.pkl')
    df_query.to_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/data/online/query.pkl')


if __name__ == '__main__':
    df_train_click = pd.read_csv('/home/xiaoguzai/数据/新闻推荐/train_click_log.csv')
    df_test_click = pd.read_csv('/home/xiaoguzai/数据/新闻推荐/testA_click_log.csv')
