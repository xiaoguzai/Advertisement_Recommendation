...
if __name__ == '__main__':
    if mode == 'valid':
        df_feature = pd.read_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/data/offline/recall_head.pkl')
        df_click = pd.read_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/data/offline/click.pkl')

    else:
        df_feature = pd.read_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/data/online/recall_head.pkl')
    ...
    # 保存特征文件
    if mode == 'valid':
        df_feature.to_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/data/offline/head_feature.pkl')
