...
def recall(df_query, article_vec_map, article_index, user_item_dict,
    ...
    os.makedirs('/home/xiaoguzai/数据/新闻推荐/user_data/tmp/w2v', exist_ok=True)
    df_data.to_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/tmp/w2v/{}.pkl'.format(worker_id))
...
if __name__ == '__main__':
    if mode == 'valid':
        ...
        os.makedirs('/home/xiaoguzai/数据/新闻推荐/user_data/data/offline', exist_ok=True)
        os.makedirs('/home/xiaoguzai/数据/新闻推荐/user_data/model/offline', exist_ok=True)

        w2v_file = '/home/xiaoguzai/数据/新闻推荐/user_data/data/offline/article_w2v.pkl'
        model_path = '/home/xiaoguzai/数据/新闻推荐/user_data/model/offline'
    else:
        ...
        os.makedirs('/home/xiaoguzai/数据/新闻推荐/user_data/data/online', exist_ok=True)
        os.makedirs('/home/xiaoguzai/数据/新闻推荐/user_data/model/online', exist_ok=True)

        w2v_file = '/home/xiaoguzai/数据/新闻推荐/user_data/data/online/article_w2v.pkl'
        model_path = '/home/xiaoguzai/数据/新闻推荐/user_data/model/online'
    ...
    r"""
    # 清空临时文件夹
    for path, _, file_list in os.walk('/home/xiaoguzai/数据/新闻推荐/user_data/tmp/w2v'):
    ...
    # 保存召回结果
    if mode == 'valid':
        df_data.to_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/data/offline/recall_w2v.pkl')
    else:
        df_data.to_pickle('/home/xiaoguzai/数据/新闻推荐/user_data/data/online/recall_w2v.pkl')
